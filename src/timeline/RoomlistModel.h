...
public slots:
    ...
    Q_SCRIPTABLE QString apiVersion() const { return nheko::RoomInfoItem::apiVersion; }
    //! Call this function to get a list of all joined rooms.
    Q_SCRIPTABLE QVector<nheko::RoomInfoItem> getRooms(const QDBusMessage &message);
...
private:
    ...
    QSharedPointer<QVector<nheko::RoomInfoItem>> m_model{new QVector<nheko::RoomInfoItem>};
    ...
    QSharedPointer<QVector<nheko::RoomInfoItem>> m_stagingModel{new QVector<nheko::RoomInfoItem>};
